...
<style>
    ...
    #student-achievements .achievement-content .description-container {
        flex-grow: 1;
        display: flex;
        flex-direction: column;
        justify-content: center;
...
<section id="student-achievements" class="wow fadeInUp">
    <div class="container">
        <div class="section-header">
            <h2 style="padding-top: 20px">Student Achievements</h2>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="achievement-item" style="animation-delay: <?php echo ($index % 5 + 1) * 0.1; ?>s">
                    ...
                    <div class="achievement-content">
                        ...
                        <div class="student-course"><?php echo htmlspecialchars($achievement['course']); ?></div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.achievement-item').forEach((item, index) => {
            // Set a staggered delay for each item
